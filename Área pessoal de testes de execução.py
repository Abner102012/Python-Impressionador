...
estoque_pedido_1000 = [qtd if 200 < qtd < 1000 else 0 for codigo, qtd in estoque]
estoque_pedido_200 = [qtd if qtd < 200 else 0 for codigo, qtd in estoque]

print(estoque_pedido_1000)
print(estoque_pedido_200)
